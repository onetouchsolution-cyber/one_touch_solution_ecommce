...
const LoginPage = () => {
    ...
    return (
        <div className="flex justify-center items-center h-[80vh] relative overflow-hidden">
            {/* Background decoration */}
            <div className="absolute top-0 left-0 w-full h-full bg-slate-50 z-0">
                <div className="absolute top-[-10%] right-[-5%] w-96 h-96 bg-brand-100 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob"></div>
                <div className="absolute bottom-[-10%] left-[-5%] w-96 h-96 bg-accent/20 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob animation-delay-2000"></div>
            </div>
            ...
            >
                <div className="text-center mb-8">
                    ...
                    <p className="text-slate-500 mt-2">Sign in to access your premium parts</p>
                </div>
                ...
                <form onSubmit={submitHandler} className="space-y-5">
                    ...
                    <div className="flex justify-between items-center text-sm">
                        <label className="flex items-center text-slate-600 cursor-pointer">
                            <input type="checkbox" className="mr-2 rounded text-brand-600 focus:ring-brand-500 border-gray-300" />
                            Remember me
                        </label>
                        <a href="#" className="text-brand-600 hover:text-brand-700 font-medium hover:underline">Forgot Password?</a>
                    </div>
